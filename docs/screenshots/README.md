...
![部品で置いた目印](2026-09-16-elements-markers.jpg)

![ポップアップ](2026-09-16-elements-popup.jpg)

**撮って初めて分かったこと**: 最初の 1 枚ではポップアップの文字が読めませんでした。
MapLibre のポップアップは白地で、文字色をページから継承するためです
（暗いページの明るい文字が、そのまま白地に乗っていました）。部品側で直してあります。
**テストは通っていました。撮らなければ気づきません。**
